...
<form action="" method="post" role="from" class="smart-green">
    ...
    <label>
        <span>&nbsp;</span>
        <a href="http://localhost:8080/JSP/Teacher/AddNeedHomework.jsp">
    ...
    <label>
        <span>&nbsp;</span>
        <a href="http://localhost:8080/JSP/Teacher/AddStudent.jsp">
    ...
    <label>
        <span>&nbsp;</span>
        <a href="http://localhost:8080/JSP/Teacher/SearchByCond.jsp">
    ...
    <label>
        <span>&nbsp;</span>
        <a href="http://localhost:8080/allhomework">
