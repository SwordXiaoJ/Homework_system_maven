...
<form action="" method="post" role="from" class="smart-green">
    ...
    <label>
        <span>&nbsp;</span>
        <a href="http://localhost:8080/myhomework?my_id=<%=my_id%>">
    ...
    <label>
        <span>&nbsp;</span>
        <a href="http://localhost:8080/JSP/Student/SubmitHome.jsp?my_id=<%=my_id%>">
    ...
    <label>
        <span>&nbsp;</span>
        <a href="http://localhost:8080/needhomework?my_id=<%=my_id%>">
